...
**charges** | [**\Lago\LagoPhpClient\Model\PlanCreateInputPlanChargesInner[]**](PlanCreateInputPlanChargesInner.md) | Additional usage-based charges for this plan. | [optional]
