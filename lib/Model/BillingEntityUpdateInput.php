...
/**
 * BillingEntityUpdateInput Class Doc Comment
 *
 * @category Class
 ...
 */
class BillingEntityUpdateInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingEntityUpdateInput';
    ...
    */
     ...
     * Sets tax_codes
     *
     * @param string[]|null $tax_codes The tax codes that should be associated with this billing entity
     *
     * @return self
     */
     ...
     * Sets logo
     *
     * @param string|null $logo The base64 encoded logo image for the billing entity. Sending \"null\" will remove the logo, if any exist.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $invoice_custom_section_codes The codes of the invoice custom section that should be associated with this billing entity
     *
     * @return self
     */
