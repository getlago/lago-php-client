...
/**
 * PaymentRequiresActionRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class PaymentRequiresActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentRequiresAction_request';
    ...
    public const WEBHOOK_TYPE_PAYMENT_REQUIRES_ACTION = 'payment.requires_action';
    public const OBJECT_TYPE_PAYMENT = 'payment';
    ...
    {
        return [
            self::WEBHOOK_TYPE_PAYMENT_REQUIRES_ACTION,
        ];
    }
