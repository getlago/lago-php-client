...
/**
 * InvoiceResyncedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceResyncedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoiceResynced_request';
    ...
    public const WEBHOOK_TYPE_INVOICE_RESYNCED = 'invoice.resynced';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_RESYNCED,
        ];
    }
