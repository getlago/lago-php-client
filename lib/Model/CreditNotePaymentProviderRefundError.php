...
/**
 * CreditNotePaymentProviderRefundError Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CreditNotePaymentProviderRefundError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNotePaymentProviderRefundError';
    ...
    protected static $attributeMap = [
        'lago_credit_note_id' => 'lago_credit_note_id',
    ...
    protected static $setters = [
        'lago_credit_note_id' => 'setLagoCreditNoteId',
    ...
    protected static $getters = [
        'lago_credit_note_id' => 'getLagoCreditNoteId',
    ...
    {
        $this->setIfExists('lago_credit_note_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lago_credit_note_id'] === null) {
            $invalidProperties[] = "'lago_credit_note_id' can't be null";
        }
    ...
    /**
     * Gets lago_credit_note_id
     *
     * @return string
     */
    public function getLagoCreditNoteId()
    {
        return $this->container['lago_credit_note_id'];
    }

    /**
     * Sets lago_credit_note_id
     *
     * @param string $lago_credit_note_id Unique identifier assigned to the credit note within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the credit note record within the Lago system.
     *
     * @return self
     */
    public function setLagoCreditNoteId($lago_credit_note_id)
    {
        if (is_null($lago_credit_note_id)) {
            throw new \InvalidArgumentException('non-nullable lago_credit_note_id cannot be null');
        }
        $this->container['lago_credit_note_id'] = $lago_credit_note_id;
