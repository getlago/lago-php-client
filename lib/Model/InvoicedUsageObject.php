...
/**
 * InvoicedUsageObject Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoicedUsageObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicedUsageObject';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code The code of the usage-based billable metrics.
     *
     * @return self
     */
