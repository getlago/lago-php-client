...
/**
 * GetCustomerPortalUrl200ResponseCustomer Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class GetCustomerPortalUrl200ResponseCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getCustomerPortalUrl_200_response_customer';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['portal_url'] === null) {
            $invalidProperties[] = "'portal_url' can't be null";
        }
     ...
     * Sets portal_url
     *
     * @param string $portal_url An embeddable link for displaying a customer portal
     *
     * @return self
     */
