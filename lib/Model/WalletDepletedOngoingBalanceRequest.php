...
/**
 * WalletDepletedOngoingBalanceRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class WalletDepletedOngoingBalanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'walletDepletedOngoingBalance_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'wallet' => '\Lago\LagoPhpClient\Model\WalletObject'
    ];
    ...
    public const WEBHOOK_TYPE_WALLET_DEPLETED_ONGOING_BALANCE = 'wallet.depleted_ongoing_balance';
    public const OBJECT_TYPE_WALLET = 'wallet';
    ...
    {
        return [
            self::WEBHOOK_TYPE_WALLET_DEPLETED_ONGOING_BALANCE,
        ];
    }
    ...
    */
     ...
     * Gets wallet
     *
     * @return \Lago\LagoPhpClient\Model\WalletObject
     */
     ...
     * Sets wallet
     *
     * @param \Lago\LagoPhpClient\Model\WalletObject $wallet wallet
     *
     * @return self
     */
