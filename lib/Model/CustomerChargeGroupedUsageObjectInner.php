...
/**
 * CustomerChargeGroupedUsageObjectInner Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerChargeGroupedUsageObjectInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerChargeGroupedUsageObject_inner';
    ...
    */
    ...
    public function setUnits($units)
    {
        ...
        if ((!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($units)))) {
            throw new \InvalidArgumentException("invalid value for \$units when calling CustomerChargeGroupedUsageObjectInner., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
