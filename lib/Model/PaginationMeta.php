...
class PaginationMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets next_page
     *
     * @param int|null $next_page Next page.
     *
     * @return self
     */
     ...
     * Sets prev_page
     *
     * @param int|null $prev_page Previous page.
     *
     * @return self
     */
    public function setPrevPage($prev_page)
    {
        if (is_null($prev_page)) {
            array_push($this->openAPINullablesSetToNull, 'prev_page');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('prev_page', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
