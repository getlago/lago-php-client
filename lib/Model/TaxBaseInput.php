...
/**
 * TaxBaseInput Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class TaxBaseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxBaseInput';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code Unique code used to identify the tax associated with the API request.
     *
     * @return self
     */
     ...
     * Sets rate
     *
     * @param string|null $rate The percentage rate of the tax
     *
     * @return self
     */
    public function setRate($rate)
    {
        ...
        if ((!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($rate)))) {
            throw new \InvalidArgumentException("invalid value for \$rate when calling TaxBaseInput., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
     ...
     *
     * @param bool|null $applied_to_organization This field is deprecated and will be removed in a future version. When set to true, it applies the tax to the organization's default billing entity. To apply or remove a tax from any billing entity (including the default one), please use the `PUT /billing_entities/:code` endpoint instead.
     *
     * @return self
     * @deprecated
     */
