...
/**
 * WalletTransactionCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class WalletTransactionCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'walletTransactionCreated_request';
    ...
    public const WEBHOOK_TYPE_WALLET_TRANSACTION_CREATED = 'wallet_transaction.created';
    ...
    {
        return [
            self::WEBHOOK_TYPE_WALLET_TRANSACTION_CREATED,
        ];
    }
