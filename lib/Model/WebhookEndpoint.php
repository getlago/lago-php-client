...
class WebhookEndpoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'webhook_endpoint' => '\Lago\LagoPhpClient\Model\WebhookEndpointObject'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['webhook_endpoint'] === null) {
            $invalidProperties[] = "'webhook_endpoint' can't be null";
        }
     ...
     *
     * @param \Lago\LagoPhpClient\Model\WebhookEndpointObject $webhook_endpoint webhook_endpoint
     *
     * @return self
     */
