...
/**
 * BillingEntityObjectExtended Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class BillingEntityObjectExtended implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingEntityObjectExtended';
    ...
    protected static $openAPITypes = [
        ...
        'selected_invoice_custom_sections' => '\Lago\LagoPhpClient\Model\InvoiceCustomSectionObject[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'taxes' => null,
        'selected_invoice_custom_sections' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'updated_at' => false,
        'taxes' => false,
        'selected_invoice_custom_sections' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'taxes' => 'taxes',
        'selected_invoice_custom_sections' => 'selected_invoice_custom_sections'
    ];
    ...
    protected static $setters = [
        ...
        'taxes' => 'setTaxes',
        'selected_invoice_custom_sections' => 'setSelectedInvoiceCustomSections'
    ];
    ...
    protected static $getters = [
        ...
        'taxes' => 'getTaxes',
        'selected_invoice_custom_sections' => 'getSelectedInvoiceCustomSections'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('selected_invoice_custom_sections', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets taxes
     *
     * @param \Lago\LagoPhpClient\Model\TaxObject[]|null $taxes taxes
     *
     * @return self
     */
    ...
    /**
     * Gets selected_invoice_custom_sections
     *
     * @return \Lago\LagoPhpClient\Model\InvoiceCustomSectionObject[]|null
     */
    public function getSelectedInvoiceCustomSections()
    {
        return $this->container['selected_invoice_custom_sections'];
    }

    /**
     * Sets selected_invoice_custom_sections
     *
     * @param \Lago\LagoPhpClient\Model\InvoiceCustomSectionObject[]|null $selected_invoice_custom_sections selected_invoice_custom_sections
     *
     * @return self
     */
    public function setSelectedInvoiceCustomSections($selected_invoice_custom_sections)
    {
        if (is_null($selected_invoice_custom_sections)) {
            throw new \InvalidArgumentException('non-nullable selected_invoice_custom_sections cannot be null');
        }
        $this->container['selected_invoice_custom_sections'] = $selected_invoice_custom_sections;
