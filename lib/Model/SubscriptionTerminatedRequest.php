...
/**
 * SubscriptionTerminatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionTerminatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'subscriptionTerminated_request';
    ...
    public const WEBHOOK_TYPE_SUBSCRIPTION_TERMINATED = 'subscription.terminated';
    ...
    {
        return [
            self::WEBHOOK_TYPE_SUBSCRIPTION_TERMINATED,
        ];
    }
