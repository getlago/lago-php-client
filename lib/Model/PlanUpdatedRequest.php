...
/**
 * PlanUpdatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class PlanUpdatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'planUpdated_request';
    ...
    public const WEBHOOK_TYPE_PLAN_UPDATED = 'plan.updated';
    ...
    {
        return [
            self::WEBHOOK_TYPE_PLAN_UPDATED,
        ];
    }
