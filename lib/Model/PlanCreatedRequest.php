...
/**
 * PlanCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class PlanCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'planCreated_request';
    ...
    public const WEBHOOK_TYPE_PLAN_CREATED = 'plan.created';
    public const OBJECT_TYPE_PLAN = 'plan';
    ...
    {
        return [
            self::WEBHOOK_TYPE_PLAN_CREATED,
        ];
    }
    ...
    */
     ...
     * Gets plan
     *
     * @return \Lago\LagoPhpClient\Model\PlanObject
     */
     ...
     * Sets plan
     *
     * @param \Lago\LagoPhpClient\Model\PlanObject $plan plan
     *
     * @return self
     */
