...
/**
 * InvoicePaymentStatusUpdatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePaymentStatusUpdatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoicePaymentStatusUpdated_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'invoice' => '\Lago\LagoPhpClient\Model\InvoiceObjectExtended'
    ];
    ...
    public const WEBHOOK_TYPE_INVOICE_PAYMENT_STATUS_UPDATED = 'invoice.payment_status_updated';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_PAYMENT_STATUS_UPDATED,
        ];
    }
    ...
    */
     ...
     * Sets invoice
     *
     * @param \Lago\LagoPhpClient\Model\InvoiceObjectExtended $invoice invoice
     *
     * @return self
     */
