...
class CouponBaseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'applies_to' => '\Lago\LagoPhpClient\Model\CouponBaseInputAppliesTo'
    ];
    ...
    */
    ...
    public function setPercentageRate($percentage_rate)
    {
        ...
        if (!is_null($percentage_rate) && (!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($percentage_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$percentage_rate when calling CouponBaseInput., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
     ...
     * Gets applies_to
     *
     * @return \Lago\LagoPhpClient\Model\CouponBaseInputAppliesTo|null
     */
     ...
     * Sets applies_to
     *
     * @param \Lago\LagoPhpClient\Model\CouponBaseInputAppliesTo|null $applies_to applies_to
     *
     * @return self
     */
