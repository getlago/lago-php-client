...
/**
 * OrganizationBillingConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class OrganizationBillingConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationBillingConfiguration';
    ...
    */
     ...
     * Sets invoice_footer
     *
     * @param string|null $invoice_footer The customer invoice message that appears at the bottom of each billing documents.
     *
     * @return self
     */
     ...
     *
     * @param int|null $invoice_grace_period The grace period, expressed in days, for finalizing the invoice. This period refers to the additional time granted to your customers beyond the invoice due date to adjust usage and line items. Can be overwritten by the customer's grace period.
     *
     * @return self
     */
     ...
     *
     * @param string|null $document_locale The locale of the billing documents, expressed in the ISO 639-1 format. This field indicates the language or regional variant used for the documents content issued or the embeddable customer portal.
     *
     * @return self
     */
