 ...
 */
class AddOnObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddOnObject';
    ...
    */
     ...
     * Sets lago_id
     *
     * @param string $lago_id Unique identifier of the add-on, created by Lago.
     *
     * @return self
     */
     ...
     * Sets amount_cents
     *
     * @param int $amount_cents The cost of the add-on in cents, excluding any applicable taxes, that is billed to a customer. By creating a one-off invoice, you will be able to override this value.
     *
     * @return self
     */
     ...
     *
     * @param \Lago\LagoPhpClient\Model\Currency $amount_currency The currency of the add-on.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string $description The description of the add-on.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date and time when the add-on was created. It is expressed in UTC format according to the ISO 8601 datetime standard. This field provides the timestamp for the exact moment when the add-on was initially created.
     *
     * @return self
     */
     ...
     * Sets taxes
     *
     * @param \Lago\LagoPhpClient\Model\TaxObject[]|null $taxes All taxes applied to the add-on.
     *
     * @return self
     */
