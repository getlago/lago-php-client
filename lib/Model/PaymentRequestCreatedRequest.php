...
/**
 * PaymentRequestCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class PaymentRequestCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentRequestCreated_request';
    ...
    public const WEBHOOK_TYPE_PAYMENT_REQUEST_CREATED = 'payment_request.created';
    ...
    {
        return [
            self::WEBHOOK_TYPE_PAYMENT_REQUEST_CREATED,
        ];
    }
