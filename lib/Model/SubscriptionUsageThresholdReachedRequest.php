...
/**
 * SubscriptionUsageThresholdReachedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionUsageThresholdReachedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'subscriptionUsageThresholdReached_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'subscription' => '\Lago\LagoPhpClient\Model\SubscriptionWithThresholdObject'
    ];
    ...
    public const WEBHOOK_TYPE_SUBSCRIPTION_USAGE_THRESHOLD_REACHED = 'subscription.usage_threshold_reached';
    ...
    {
        return [
            self::WEBHOOK_TYPE_SUBSCRIPTION_USAGE_THRESHOLD_REACHED,
        ];
    }
    ...
    */
     ...
     * Gets subscription
     *
     * @return \Lago\LagoPhpClient\Model\SubscriptionWithThresholdObject
     */
     ...
     * Sets subscription
     *
     * @param \Lago\LagoPhpClient\Model\SubscriptionWithThresholdObject $subscription subscription
     *
     * @return self
     */
