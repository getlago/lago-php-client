...
/**
 * InvoiceOneOffInputInvoiceFeesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceOneOffInputInvoiceFeesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceOneOffInput_invoice_fees_inner';
    ...
    */
     ...
     *
     * @param int|null $unit_amount_cents unit_amount_cents
     *
     * @return self
     */
    public function setUnitAmountCents($unit_amount_cents)
    {
        if (is_null($unit_amount_cents)) {
            throw new \InvalidArgumentException('non-nullable unit_amount_cents cannot be null');
        }
