...
/**
 * InvoiceVoidedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceVoidedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoiceVoided_request';
    ...
    public const WEBHOOK_TYPE_INVOICE_VOIDED = 'invoice.voided';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_VOIDED,
        ];
    }
