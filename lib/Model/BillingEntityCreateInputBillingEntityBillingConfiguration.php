...
/**
 * BillingEntityCreateInputBillingEntityBillingConfiguration Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class BillingEntityCreateInputBillingEntityBillingConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingEntityCreateInput_billing_entity_billing_configuration';
    ...
    */
     ...
     *
     * @param string|null $document_locale The language of the documents generated for this billing entity
     *
     * @return self
     */
     ...
     *
     * @param int|null $invoice_grace_period The grace period (in days) for invoice finalization
     *
     * @return self
     */
