...
/**
 * InvoicePaymentOverdueRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePaymentOverdueRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoicePaymentOverdue_request';
    ...
    public const WEBHOOK_TYPE_INVOICE_PAYMENT_OVERDUE = 'invoice.payment_overdue';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_PAYMENT_OVERDUE,
        ];
    }
