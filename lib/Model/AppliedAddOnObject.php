...
/**
 * AppliedAddOnObject Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AppliedAddOnObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppliedAddOnObject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('lago_add_on_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lago_add_on_id'] === null) {
            $invalidProperties[] = "'lago_add_on_id' can't be null";
        }
     ...
     * @return string
     */
    public function getLagoAddOnId()
    {
        return $this->container['lago_add_on_id'];
    }

    /**
     * Sets lago_add_on_id
     *
     * @param string $lago_add_on_id lago_add_on_id
     *
     * @return self
     */
    public function setLagoAddOnId($lago_add_on_id)
    {
        if (is_null($lago_add_on_id)) {
            throw new \InvalidArgumentException('non-nullable lago_add_on_id cannot be null');
        }
        $this->container['lago_add_on_id'] = $lago_add_on_id;
     ...
     * Sets add_on_code
     *
     * @param string $add_on_code add_on_code
     *
     * @return self
     */
