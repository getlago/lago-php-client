...
/**
 * PaymentRequestPaymentStatusUpdatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class PaymentRequestPaymentStatusUpdatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'paymentRequestPaymentStatusUpdated_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'payment_request' => '\Lago\LagoPhpClient\Model\PaymentRequestObject'
    ];
    ...
    public const WEBHOOK_TYPE_PAYMENT_REQUEST_PAYMENT_STATUS_UPDATED = 'payment_request.payment_status_updated';
    public const OBJECT_TYPE_PAYMENT_REQUEST = 'payment_request';
    ...
    {
        return [
            self::WEBHOOK_TYPE_PAYMENT_REQUEST_PAYMENT_STATUS_UPDATED,
        ];
    }
    ...
    {
        return [
            self::OBJECT_TYPE_PAYMENT_REQUEST,
        ];
    }
    ...
    */
     ...
     *
     * @return \Lago\LagoPhpClient\Model\PaymentRequestObject
     */
     ...
     *
     * @param \Lago\LagoPhpClient\Model\PaymentRequestObject $payment_request payment_request
     *
     * @return self
     */
