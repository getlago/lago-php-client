...
/**
 * SubscriptionTrialEndedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionTrialEndedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'subscriptionTrialEnded_request';
    ...
    public const WEBHOOK_TYPE_SUBSCRIPTION_TRIAL_ENDED = 'subscription.trial_ended';
    ...
    {
        return [
            self::WEBHOOK_TYPE_SUBSCRIPTION_TRIAL_ENDED,
        ];
    }
