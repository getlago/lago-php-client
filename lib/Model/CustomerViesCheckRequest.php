...
/**
 * CustomerViesCheckRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerViesCheckRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerViesCheck_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'customer' => '\Lago\LagoPhpClient\Model\CustomerViesCheckObject'
    ];
    ...
    public const WEBHOOK_TYPE_CUSTOMER_VIES_CHECK = 'customer.vies_check';
    ...
    {
        return [
            self::WEBHOOK_TYPE_CUSTOMER_VIES_CHECK,
        ];
    }
    ...
    */
     ...
     * Gets customer
     *
     * @return \Lago\LagoPhpClient\Model\CustomerViesCheckObject
     */
     ...
     * Sets customer
     *
     * @param \Lago\LagoPhpClient\Model\CustomerViesCheckObject $customer customer
     *
     * @return self
     */
