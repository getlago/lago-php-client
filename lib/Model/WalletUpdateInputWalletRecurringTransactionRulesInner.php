...
/**
 * WalletUpdateInputWalletRecurringTransactionRulesInner Class Doc Comment
 *
 * @category Class
 ...
 */
class WalletUpdateInputWalletRecurringTransactionRulesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletUpdateInput_wallet_recurring_transaction_rules_inner';
    ...
    */
     ...
     * Sets lago_id
     *
     * @param string|null $lago_id A unique identifier for the recurring transaction rule in the Lago application. Can be used to update a recurring transaction rule.
     *
     * @return self
     */
     ...
     * Sets trigger
     *
     * @param string|null $trigger The trigger. Possible values are `interval` or `threshold`.
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param string|null $interval The interval used for recurring top-up. It represents the frequency at which automatic top-up occurs. The interval can be one of the following values: `weekly`, `monthly`, `quarterly` or `yearly`. Required only when trigger is set to `interval`.
     *
     * @return self
     */
    ...
    public function setThresholdCredits($threshold_credits)
    {
        ...
        if ((!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($threshold_credits)))) {
            throw new \InvalidArgumentException("invalid value for \$threshold_credits when calling WalletUpdateInputWalletRecurringTransactionRulesInner., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
    ...
    public function setPaidCredits($paid_credits)
    {
        ...
        if (!is_null($paid_credits) && (!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($paid_credits)))) {
            throw new \InvalidArgumentException("invalid value for \$paid_credits when calling WalletUpdateInputWalletRecurringTransactionRulesInner., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
    ...
    public function setGrantedCredits($granted_credits)
    {
        ...
        if (!is_null($granted_credits) && (!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($granted_credits)))) {
            throw new \InvalidArgumentException("invalid value for \$granted_credits when calling WalletUpdateInputWalletRecurringTransactionRulesInner., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
    ...
    public function setTargetOngoingBalance($target_ongoing_balance)
    {
        ...
        if ((!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($target_ongoing_balance)))) {
            throw new \InvalidArgumentException("invalid value for \$target_ongoing_balance when calling WalletUpdateInputWalletRecurringTransactionRulesInner., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
