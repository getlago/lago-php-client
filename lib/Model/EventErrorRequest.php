...
/**
 * EventErrorRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class EventErrorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'eventError_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'event_error' => '\Lago\LagoPhpClient\Model\EventErrorsObject'
    ];
    ...
    public const WEBHOOK_TYPE_EVENT_ERROR = 'event.error';
    public const OBJECT_TYPE_EVENT_ERROR = 'event_error';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('event_error', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['event_error'] === null) {
            $invalidProperties[] = "'event_error' can't be null";
        }
     ...
     * Gets event_error
     *
     * @return \Lago\LagoPhpClient\Model\EventErrorsObject
     */
    public function getEventError()
    {
        return $this->container['event_error'];
    }

    /**
     * Sets event_error
     *
     * @param \Lago\LagoPhpClient\Model\EventErrorsObject $event_error event_error
     *
     * @return self
     */
    public function setEventError($event_error)
    {
        if (is_null($event_error)) {
            throw new \InvalidArgumentException('non-nullable event_error cannot be null');
        }
        $this->container['event_error'] = $event_error;
