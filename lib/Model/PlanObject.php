...
class PlanObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'charges' => '\Lago\LagoPhpClient\Model\ChargeObject[]',
    ...
    */
     ...
     * Sets lago_id
     *
     * @param string $lago_id Unique identifier of the plan created by Lago.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date and time when the plan was created. It is expressed in UTC format according to the ISO 8601 datetime standard. This field provides the timestamp for the exact moment when the plan was initially created.
     *
     * @return self
     */
     ...
     * Sets interval
     *
     * @param string $interval The interval used for recurring billing. It represents the frequency at which subscription billing occurs. The interval can be one of the following values: `yearly`, `quarterly`, `monthly` or `weekly`.
     *
     * @return self
     */
     ...
     * Sets amount_cents
     *
     * @param int $amount_cents The base cost of the plan, excluding any applicable taxes, that is billed on a recurring basis. This value is defined at 0 if your plan is a pay-as-you-go plan.
     *
     * @return self
     */
     ...
     *
     * @param \Lago\LagoPhpClient\Model\Currency $amount_currency The currency of the plan. It indicates the monetary unit in which the plan's cost, including taxes and usage-based charges, is expressed.
     *
     * @return self
     */
     ...
     * Gets charges
     *
     * @return \Lago\LagoPhpClient\Model\ChargeObject[]|null
     */
     ...
     * Sets charges
     *
     * @param \Lago\LagoPhpClient\Model\ChargeObject[]|null $charges Additional usage-based charges for this plan.
     *
     * @return self
     */
     ...
     * Sets taxes
     *
     * @param \Lago\LagoPhpClient\Model\TaxObject[]|null $taxes All taxes applied to the plan.
     *
     * @return self
     */
     ...
     *
     * @param \Lago\LagoPhpClient\Model\UsageThresholdObject[]|null $usage_thresholds List of usage thresholds applied to the plan.
     *
     * @return self
     */
