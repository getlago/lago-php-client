...
/**
 * InvoicePaidCreditAddedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePaidCreditAddedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoicePaidCreditAdded_request';
    ...
    public const WEBHOOK_TYPE_INVOICE_PAID_CREDIT_ADDED = 'invoice.paid_credit_added';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_PAID_CREDIT_ADDED,
        ];
    }
