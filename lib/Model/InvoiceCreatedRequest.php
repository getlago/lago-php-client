...
/**
 * InvoiceCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoiceCreated_request';
    ...
    public const WEBHOOK_TYPE_INVOICE_CREATED = 'invoice.created';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_CREATED,
        ];
    }
