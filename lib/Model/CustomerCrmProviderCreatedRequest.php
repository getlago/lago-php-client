...
/**
 * CustomerCrmProviderCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerCrmProviderCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerCrmProviderCreated_request';
    ...
    public const WEBHOOK_TYPE_CUSTOMER_CRM_PROVIDER_CREATED = 'customer.crm_provider_created';
    ...
    {
        return [
            self::WEBHOOK_TYPE_CUSTOMER_CRM_PROVIDER_CREATED,
        ];
    }
