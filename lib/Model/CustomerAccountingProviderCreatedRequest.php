...
/**
 * CustomerAccountingProviderCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerAccountingProviderCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerAccountingProviderCreated_request';
    ...
    public const WEBHOOK_TYPE_CUSTOMER_ACCOUNTING_PROVIDER_CREATED = 'customer.accounting_provider_created';
    public const OBJECT_TYPE_CUSTOMER = 'customer';
    ...
    {
        return [
            self::WEBHOOK_TYPE_CUSTOMER_ACCOUNTING_PROVIDER_CREATED,
        ];
    }
    ...
    */
     ...
     * Gets customer
     *
     * @return \Lago\LagoPhpClient\Model\CustomerObject
     */
     ...
     * Sets customer
     *
     * @param \Lago\LagoPhpClient\Model\CustomerObject $customer customer
     *
     * @return self
     */
