...
/**
 * CustomerViesCheckObject Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerViesCheckObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerViesCheckObject';
    ...
    protected static $openAPITypes = [
        ...
        'vies_check' => '\Lago\LagoPhpClient\Model\CustomerViesCheckObjectAllOfViesCheck'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('vies_check', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets vies_check
     *
     * @return \Lago\LagoPhpClient\Model\CustomerViesCheckObjectAllOfViesCheck|null
     */
    public function getViesCheck()
    {
        return $this->container['vies_check'];
    }

    /**
     * Sets vies_check
     *
     * @param \Lago\LagoPhpClient\Model\CustomerViesCheckObjectAllOfViesCheck|null $vies_check vies_check
     *
     * @return self
     */
    public function setViesCheck($vies_check)
    {
        if (is_null($vies_check)) {
            throw new \InvalidArgumentException('non-nullable vies_check cannot be null');
        }
        $this->container['vies_check'] = $vies_check;
