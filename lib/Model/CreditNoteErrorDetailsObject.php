...
/**
 * CreditNoteErrorDetailsObject Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteErrorDetailsObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteErrorDetailsObject';
    ...
    public const ERROR_CODE_NOT_PROVIDED = 'not_provided';
    public const ERROR_CODE_TAX_ERROR = 'tax_error';
    public const ERROR_CODE_TAX_VOIDING_ERROR = 'tax_voiding_error';
    public const ERROR_CODE_INVOICE_GENERATION_ERROR = 'invoice_generation_error';
    ...
    {
        return [
            self::ERROR_CODE_NOT_PROVIDED,
            self::ERROR_CODE_TAX_ERROR,
            self::ERROR_CODE_TAX_VOIDING_ERROR,
            self::ERROR_CODE_INVOICE_GENERATION_ERROR,
        ];
    }
    ...
    */
     ...
     * Sets lago_id
     *
     * @param string $lago_id The credit note error details unique identifier, created by Lago.
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param string $error_code The type of the error.
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param object $details The details of the error.
     *
     * @return self
     */
