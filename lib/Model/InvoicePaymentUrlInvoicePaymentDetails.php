...
/**
 * InvoicePaymentUrlInvoicePaymentDetails Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePaymentUrlInvoicePaymentDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicePaymentUrl_invoice_payment_details';
    ...
    */
     ...
     *
     * @param string|null $lago_invoice_id Unique identifier assigned to the invoice within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the invoice's record within the Lago system
     *
     * @return self
     */
     ...
     * Sets payment_url
     *
     * @param string|null $payment_url The generated Payment URL for the Invoice.
     *
     * @return self
     */
