...
/**
 * CustomerChargeUsageObjectBillableMetric Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerChargeUsageObjectBillableMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerChargeUsageObject_billable_metric';
    ...
    */
     ...
     * Sets lago_id
     *
     * @param string $lago_id Unique identifier assigned to the billable metric within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the billable metric's record within the Lago system.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of the billable metric used for this charge.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string $code The code of the billable metric used for this charge.
     *
     * @return self
     */
     ...
     *
     * @param string $aggregation_type The aggregation type of the billable metric used for this charge. Possible values are `count_agg`, `sum_agg`, `max_agg` or `unique_count_agg`.
     *
     * @return self
     */
