...
/**
 * PaymentRequestPaymentFailureObject Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class PaymentRequestPaymentFailureObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentRequestPaymentFailureObject';
    ...
    protected static $openAPIFormats = [
        'lago_payment_request_id' => 'uuid',
        'lago_invoice_ids' => 'uuid',
    ...
    protected static array $openAPINullables = [
        'lago_payment_request_id' => false,
        'lago_invoice_ids' => false,
    ...
    protected static $attributeMap = [
        'lago_payment_request_id' => 'lago_payment_request_id',
    ...
    protected static $setters = [
        'lago_payment_request_id' => 'setLagoPaymentRequestId',
        'lago_invoice_ids' => 'setLagoInvoiceIds',
    ...
    protected static $getters = [
        'lago_payment_request_id' => 'getLagoPaymentRequestId',
        'lago_invoice_ids' => 'getLagoInvoiceIds',
    ...
    {
        $this->setIfExists('lago_payment_request_id', $data ?? [], null);
        $this->setIfExists('lago_invoice_ids', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lago_payment_request_id'] === null) {
            $invalidProperties[] = "'lago_payment_request_id' can't be null";
        }
        if ($this->container['lago_invoice_ids'] === null) {
            $invalidProperties[] = "'lago_invoice_ids' can't be null";
        }
    ...
    /**
     * Gets lago_payment_request_id
     *
     * @return string
     */
    public function getLagoPaymentRequestId()
    {
        return $this->container['lago_payment_request_id'];
    }

    /**
     * Sets lago_payment_request_id
     *
     * @param string $lago_payment_request_id Unique identifier assigned to the payment request within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the payment request record within the Lago system.
     *
     * @return self
     */
    public function setLagoPaymentRequestId($lago_payment_request_id)
    {
        if (is_null($lago_payment_request_id)) {
            throw new \InvalidArgumentException('non-nullable lago_payment_request_id cannot be null');
        }
        $this->container['lago_payment_request_id'] = $lago_payment_request_id;

        return $this;
    }

    /**
     * Gets lago_invoice_ids
     *
     * @return string[]
     */
    public function getLagoInvoiceIds()
    {
        return $this->container['lago_invoice_ids'];
    }

    /**
     * Sets lago_invoice_ids
     *
     * @param string[] $lago_invoice_ids List of unique identifiers assigned to the invoices within the Lago application. These IDs are exclusively created by Lago and serve as unique identifiers for the invoices records within the Lago system.
     *
     * @return self
     */
    public function setLagoInvoiceIds($lago_invoice_ids)
    {
        if (is_null($lago_invoice_ids)) {
            throw new \InvalidArgumentException('non-nullable lago_invoice_ids cannot be null');
        }
        $this->container['lago_invoice_ids'] = $lago_invoice_ids;
     ...
     *
     * @param string|null $provider_customer_id Unique identifier of the customer within the payment provider
     *
     * @return self
     */
     ...
     *
     * @param string $payment_provider The type of payment provider code
     *
     * @return self
     */
     ...
     * Gets provider_error
     *
     * @return \Lago\LagoPhpClient\Model\CustomerIntegratrionErrorObjectProviderError|null
     */
     ...
     * Sets provider_error
     *
     * @param \Lago\LagoPhpClient\Model\CustomerIntegratrionErrorObjectProviderError|null $provider_error provider_error
     *
     * @return self
     */
