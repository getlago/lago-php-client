...
/**
 * CustomerUpdatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerUpdatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerUpdated_request';
    ...
    public const WEBHOOK_TYPE_CUSTOMER_UPDATED = 'customer.updated';
    ...
    {
        return [
            self::WEBHOOK_TYPE_CUSTOMER_UPDATED,
        ];
    }
