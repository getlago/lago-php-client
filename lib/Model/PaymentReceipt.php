...
class PaymentReceipt implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'payment_receipt' => '\Lago\LagoPhpClient\Model\PaymentReceiptObject'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['payment_receipt'] === null) {
            $invalidProperties[] = "'payment_receipt' can't be null";
        }
     ...
     *
     * @param \Lago\LagoPhpClient\Model\PaymentReceiptObject $payment_receipt payment_receipt
     *
     * @return self
     */
