...
/**
 * InvoicePreviewInputCustomerIntegrationCustomersInner Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePreviewInputCustomerIntegrationCustomersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicePreviewInput_customer_integration_customers_inner';
    ...
    */
     ...
     *
     * @param string $integration_type The integration type used for accounting and tax syncs. Accepted values: `anrok`.
     *
     * @return self
     */
