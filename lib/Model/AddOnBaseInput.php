...
/**
 * AddOnBaseInput Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class AddOnBaseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddOnBaseInput';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the add-on.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Unique code used to identify the add-on.
     *
     * @return self
     */
     ...
     * Sets amount_cents
     *
     * @param int|null $amount_cents The cost of the add-on in cents, excluding any applicable taxes, that is billed to a customer. By creating a one-off invoice, you will be able to override this value.
     *
     * @return self
     */
     ...
     *
     * @param \Lago\LagoPhpClient\Model\Currency|null $amount_currency The currency of the add-on.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description of the add-on.
     *
     * @return self
     */
