...
/**
 * CouponBaseInputAppliesTo Class Doc Comment
 *
 * @category Class
 ...
 */
class CouponBaseInputAppliesTo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponBaseInput_applies_to';
    ...
    */
    ...
    public function setPlanCodes($plan_codes)
    {
        if (is_null($plan_codes)) {
            array_push($this->openAPINullablesSetToNull, 'plan_codes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('plan_codes', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setBillableMetricCodes($billable_metric_codes)
    {
        if (is_null($billable_metric_codes)) {
            array_push($this->openAPINullablesSetToNull, 'billable_metric_codes');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('billable_metric_codes', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
