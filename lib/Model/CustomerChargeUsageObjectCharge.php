...
/**
 * CustomerChargeUsageObjectCharge Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerChargeUsageObjectCharge implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerChargeUsageObject_charge';
    ...
    */
     ...
     * Sets lago_id
     *
     * @param string $lago_id Unique identifier assigned to the charge within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the charge's record within the Lago system.
     *
     * @return self
     */
     ...
     * Sets charge_model
     *
     * @param string $charge_model The pricing model applied to this charge. Possible values are standard, `graduated`, `percentage`, `package` or `volume`.
     *
     * @return self
     */
