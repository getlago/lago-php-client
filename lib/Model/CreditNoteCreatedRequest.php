...
/**
 * CreditNoteCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'creditNoteCreated_request';
    ...
    public const WEBHOOK_TYPE_CREDIT_NOTE_CREATED = 'credit_note.created';
    ...
    {
        return [
            self::WEBHOOK_TYPE_CREDIT_NOTE_CREATED,
        ];
    }
