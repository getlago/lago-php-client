...
/**
 * OrganizationInputOrganization Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrganizationInputOrganization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationInput_organization';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('zipode', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getZipode()
    {
        return $this->container['zipode'];
    }

    /**
     * Sets zipode
     *
     * @param string|null $zipode zipode
     *
     * @return self
     */
    public function setZipode($zipode)
    {
        if (is_null($zipode)) {
            throw new \InvalidArgumentException('non-nullable zipode cannot be null');
        }
        $this->container['zipode'] = $zipode;
