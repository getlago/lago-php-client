...
class OrganizationObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('webhook_urls', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['document_number_prefix'] === null) {
            $invalidProperties[] = "'document_number_prefix' can't be null";
        }
        if ($this->container['billing_configuration'] === null) {
            $invalidProperties[] = "'billing_configuration' can't be null";
        }
     ...
     * Sets lago_id
     *
     * @param string $lago_id Unique identifier assigned to the organization within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the organization's record within the Lago system
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of your organization.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date of creation of your organization, represented in ISO 8601 datetime format and expressed in Coordinated Universal Time (UTC).
     *
     * @return self
     */
    ...
    {
        return $this->container['webhook_urls'];
    }

    /**
     * Sets webhook_urls
     *
     * @param string[]|null $webhook_urls The array containing your webhooks URLs.
     *
     * @return self
     */
    public function setWebhookUrls($webhook_urls)
    {
        if (is_null($webhook_urls)) {
            array_push($this->openAPINullablesSetToNull, 'webhook_urls');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('webhook_urls', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['webhook_urls'] = $webhook_urls;
     ...
     *
     * @param string $document_number_prefix Sets the prefix for invoices and credit notes. Default is the first three letters of your organization name plus the last four digits of your organization ID. Customizable within 1-10 characters, and automatically capitalized by Lago.
     *
     * @return self
     */
     ...
     *
     * @return \Lago\LagoPhpClient\Model\OrganizationBillingConfiguration
     */
     ...
     *
     * @param \Lago\LagoPhpClient\Model\OrganizationBillingConfiguration $billing_configuration billing_configuration
     *
     * @return self
     */
     ...
     * Sets taxes
     *
     * @param \Lago\LagoPhpClient\Model\TaxObject[]|null $taxes List of default organization taxes
     *
     * @return self
     */
     ...
     *
     * @param bool|null $finalize_zero_amount_invoice Indicates whether invoices with a zero total amount should be finalized. If set to true, zero amount invoices will be finalized. If set to false, zero amount invoices will not be finalized.
     *
     * @return self
     */
