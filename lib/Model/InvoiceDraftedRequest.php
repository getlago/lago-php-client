...
/**
 * InvoiceDraftedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceDraftedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoiceDrafted_request';
    ...
    public const WEBHOOK_TYPE_INVOICE_DRAFTED = 'invoice.drafted';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_DRAFTED,
        ];
    }
