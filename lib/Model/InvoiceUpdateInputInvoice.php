...
/**
 * InvoiceUpdateInputInvoice Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceUpdateInputInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceUpdateInput_invoice';
    ...
    protected static $openAPITypes = [
        ...
        'metadata' => '\Lago\LagoPhpClient\Model\InvoiceUpdateInputInvoiceMetadataInner[]'
    ];
    ...
    */
     ...
     * Sets payment_status
     *
     * @param string|null $payment_status The payment status of the invoice. Possible values are `pending`, `failed` or `succeeded`.
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \Lago\LagoPhpClient\Model\InvoiceUpdateInputInvoiceMetadataInner[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Lago\LagoPhpClient\Model\InvoiceUpdateInputInvoiceMetadataInner[]|null $metadata metadata
     *
     * @return self
     */
