...
/**
 * EventsErrorsRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class EventsErrorsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'eventsErrors_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'events_errors' => '\Lago\LagoPhpClient\Model\EventsErrorsObject'
    ];
    ...
    public const WEBHOOK_TYPE_EVENTS_ERRORS = 'events.errors';
    public const OBJECT_TYPE_EVENTS_ERRORS = 'events_errors';
    ...
    {
        return [
            self::WEBHOOK_TYPE_EVENTS_ERRORS,
        ];
    }
    ...
    {
        return [
            self::OBJECT_TYPE_EVENTS_ERRORS,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('events_errors', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['events_errors'] === null) {
            $invalidProperties[] = "'events_errors' can't be null";
        }
     ...
     * Gets events_errors
     *
     * @return \Lago\LagoPhpClient\Model\EventsErrorsObject
     */
    public function getEventsErrors()
    {
        return $this->container['events_errors'];
    }

    /**
     * Sets events_errors
     *
     * @param \Lago\LagoPhpClient\Model\EventsErrorsObject $events_errors events_errors
     *
     * @return self
     */
    public function setEventsErrors($events_errors)
    {
        if (is_null($events_errors)) {
            throw new \InvalidArgumentException('non-nullable events_errors cannot be null');
        }
        $this->container['events_errors'] = $events_errors;
