...
class CreditObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'before_vat' => 'bool',
        'item' => '\OpenAPI\Client\Model\CreditObjectItem',
        'invoice' => '\OpenAPI\Client\Model\CreditObjectInvoice'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('before_vat', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['before_vat'] === null) {
            $invalidProperties[] = "'before_vat' can't be null";
        }
    ...
    {
        return $this->container['before_vat'];
    }

    /**
     * Sets before_vat
     *
     * @param bool $before_vat before_vat
     *
     * @return self
     */
    public function setBeforeVat($before_vat)
    {
        if (is_null($before_vat)) {
            throw new \InvalidArgumentException('non-nullable before_vat cannot be null');
        }
        $this->container['before_vat'] = $before_vat;
     ...
     * Gets item
     *
     * @return \OpenAPI\Client\Model\CreditObjectItem
     */
     ...
     * Sets item
     *
     * @param \OpenAPI\Client\Model\CreditObjectItem $item item
     *
     * @return self
     */
     ...
     * Gets invoice
     *
     * @return \OpenAPI\Client\Model\CreditObjectInvoice
     */
     ...
     * Sets invoice
     *
     * @param \OpenAPI\Client\Model\CreditObjectInvoice $invoice invoice
     *
     * @return self
     */
