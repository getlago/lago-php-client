...
/**
 * CreditNoteCreateInputCreditNoteItemsInner Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteCreateInputCreditNoteItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteCreateInput_credit_note_items_inner';
    ...
    */
     ...
     * Sets fee_id
     *
     * @param string $fee_id The fee unique identifier, created by Lago.
     *
     * @return self
     */
     ...
     * Sets amount_cents
     *
     * @param int $amount_cents The amount of the credit note item, expressed in cents.
     *
     * @return self
     */
