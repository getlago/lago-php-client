...
/**
 * PlanDeletedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class PlanDeletedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'planDeleted_request';
    ...
    public const WEBHOOK_TYPE_PLAN_DELETED = 'plan.deleted';
    ...
    {
        return [
            self::WEBHOOK_TYPE_PLAN_DELETED,
        ];
    }
