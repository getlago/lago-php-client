...
class BillableMetricBaseInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'filters' => '\Lago\LagoPhpClient\Model\BillableMetricFilterInput[]'
    ];
    ...
    */
    ...
    public function setExpression($expression)
    {
        if (is_null($expression)) {
            array_push($this->openAPINullablesSetToNull, 'expression');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('expression', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets filters
     *
     * @return \Lago\LagoPhpClient\Model\BillableMetricFilterInput[]|null
     */
     ...
     * Sets filters
     *
     * @param \Lago\LagoPhpClient\Model\BillableMetricFilterInput[]|null $filters filters
     *
     * @return self
     */
