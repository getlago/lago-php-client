...
class CustomerObjectExtended implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'applicable_timezone' => '\Lago\LagoPhpClient\Model\Timezone',
        'city' => 'string',
        ...
        'metadata' => '\Lago\LagoPhpClient\Model\CustomerMetadata[]',
        'integration_customers' => '\Lago\LagoPhpClient\Model\IntegrationCustomer[]',
        'taxes' => '\Lago\LagoPhpClient\Model\TaxObject[]',
        'applicable_invoice_custom_sections' => '\Lago\LagoPhpClient\Model\InvoiceCustomSectionObject[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'taxes' => null,
        'applicable_invoice_custom_sections' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'taxes' => false,
        'applicable_invoice_custom_sections' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'taxes' => 'taxes',
        'applicable_invoice_custom_sections' => 'applicable_invoice_custom_sections'
    ];
    ...
    protected static $setters = [
        ...
        'taxes' => 'setTaxes',
        'applicable_invoice_custom_sections' => 'setApplicableInvoiceCustomSections'
    ];
    ...
    protected static $getters = [
        ...
        'taxes' => 'getTaxes',
        'applicable_invoice_custom_sections' => 'getApplicableInvoiceCustomSections'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('applicable_invoice_custom_sections', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $billing_entity_code The unique code of the billing entity associated with the customer.
     *
     * @return self
     */
     ...
     *
     * @param \Lago\LagoPhpClient\Model\Timezone $applicable_timezone The customer's applicable timezone, used for billing purposes in their local time.
     *
     * @return self
     */
     ...
     * Sets account_type
     *
     * @param string|null $account_type The type of the account. It can have one of the following values: - `customer`: the account is a customer. - `partner`: the account is a partner.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $skip_invoice_custom_sections Set to true to exclude all invoice custom sections from PDF generation for this customer only.
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \Lago\LagoPhpClient\Model\CustomerMetadata[]|null
     */
     ...
     * Sets metadata
     *
     * @param \Lago\LagoPhpClient\Model\CustomerMetadata[]|null $metadata metadata
     *
     * @return self
     */
     ...
     *
     * @return \Lago\LagoPhpClient\Model\IntegrationCustomer[]|null
     */
     ...
     *
     * @param \Lago\LagoPhpClient\Model\IntegrationCustomer[]|null $integration_customers integration_customers
     *
     * @return self
     */
     ...
     * Sets taxes
     *
     * @param \Lago\LagoPhpClient\Model\TaxObject[]|null $taxes List of customer taxes
     *
     * @return self
     */
    ...
    /**
     * Gets applicable_invoice_custom_sections
     *
     * @return \Lago\LagoPhpClient\Model\InvoiceCustomSectionObject[]|null
     */
    public function getApplicableInvoiceCustomSections()
    {
        return $this->container['applicable_invoice_custom_sections'];
    }

    /**
     * Sets applicable_invoice_custom_sections
     *
     * @param \Lago\LagoPhpClient\Model\InvoiceCustomSectionObject[]|null $applicable_invoice_custom_sections The customer’s invoice custom section used for generating invoices.
     *
     * @return self
     */
    public function setApplicableInvoiceCustomSections($applicable_invoice_custom_sections)
    {
        if (is_null($applicable_invoice_custom_sections)) {
            throw new \InvalidArgumentException('non-nullable applicable_invoice_custom_sections cannot be null');
        }
        $this->container['applicable_invoice_custom_sections'] = $applicable_invoice_custom_sections;
