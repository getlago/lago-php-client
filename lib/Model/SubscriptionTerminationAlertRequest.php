...
/**
 * SubscriptionTerminationAlertRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionTerminationAlertRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'subscriptionTerminationAlert_request';
    ...
    public const WEBHOOK_TYPE_SUBSCRIPTION_TERMINATION_ALERT = 'subscription.termination_alert';
    ...
    {
        return [
            self::WEBHOOK_TYPE_SUBSCRIPTION_TERMINATION_ALERT,
        ];
    }
