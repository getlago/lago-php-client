...
/**
 * WalletTransactionUpdatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class WalletTransactionUpdatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'walletTransactionUpdated_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'wallet_transaction' => '\Lago\LagoPhpClient\Model\WalletTransactionObject'
    ];
    ...
    protected static $setters = [
        ...
        'wallet_transaction' => 'setWalletTransaction'
    ];
    ...
    protected static $getters = [
        ...
        'wallet_transaction' => 'getWalletTransaction'
    ];
    ...
    public const WEBHOOK_TYPE_WALLET_TRANSACTION_UPDATED = 'wallet_transaction.updated';
    public const OBJECT_TYPE_WALLET_TRANSACTION = 'wallet_transaction';
    ...
    {
        return [
            self::WEBHOOK_TYPE_WALLET_TRANSACTION_UPDATED,
        ];
    }
    ...
    {
        return [
            self::OBJECT_TYPE_WALLET_TRANSACTION,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('wallet_transaction', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wallet_transaction'] === null) {
            $invalidProperties[] = "'wallet_transaction' can't be null";
        }
    ...
    /**
     * Gets wallet_transaction
     *
     * @return \Lago\LagoPhpClient\Model\WalletTransactionObject
     */
    public function getWalletTransaction()
    {
        return $this->container['wallet_transaction'];
    }

    /**
     * Sets wallet_transaction
     *
     * @param \Lago\LagoPhpClient\Model\WalletTransactionObject $wallet_transaction wallet_transaction
     *
     * @return self
     */
    public function setWalletTransaction($wallet_transaction)
    {
        if (is_null($wallet_transaction)) {
            throw new \InvalidArgumentException('non-nullable wallet_transaction cannot be null');
        }
        $this->container['wallet_transaction'] = $wallet_transaction;
