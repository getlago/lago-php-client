...
/**
 * CustomerPaymentProviderCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerPaymentProviderCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerPaymentProviderCreated_request';
    ...
    public const WEBHOOK_TYPE_CUSTOMER_PAYMENT_PROVIDER_CREATED = 'customer.payment_provider_created';
    ...
    {
        return [
            self::WEBHOOK_TYPE_CUSTOMER_PAYMENT_PROVIDER_CREATED,
        ];
    }
