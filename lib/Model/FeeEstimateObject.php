...
/**
 * FeeEstimateObject Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class FeeEstimateObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeeEstimateObject';
    ...
    protected static $openAPITypes = [
        ...
        'lago_invoice_id' => 'mixed',
        'lago_true_up_fee_id' => 'mixed',
        'lago_true_up_parent_fee_id' => 'mixed',
        ...
        'precise_total_amount' => 'float',
        'amount_currency' => '\Lago\LagoPhpClient\Model\Currency',
        'taxes_amount_cents' => 'int',
        'taxes_precise_amount' => 'float',
        'taxes_rate' => 'float',
        'units' => 'string',
        'description' => 'mixed',
        'precise_unit_amount' => 'float',
        ...
        'item' => '\Lago\LagoPhpClient\Model\FeeEstimateObjectItem'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'precise_coupons_amount_cents' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'precise_coupons_amount_cents' => false,
    ...
    protected static $attributeMap = [
        ...
        'precise_coupons_amount_cents' => 'precise_coupons_amount_cents',
    ...
    protected static $setters = [
        ...
        'precise_coupons_amount_cents' => 'setPreciseCouponsAmountCents',
    ...
    protected static $getters = [
        ...
        'precise_coupons_amount_cents' => 'getPreciseCouponsAmountCents',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('precise_coupons_amount_cents', $data ?? [], null);
    ...
    */
     ...
     * Sets lago_id
     *
     * @param mixed|null $lago_id lago_id
     *
     * @return self
     */
    ...
    public function setLagoChargeId($lago_charge_id)
    {
        if (is_null($lago_charge_id)) {
            throw new \InvalidArgumentException('non-nullable lago_charge_id cannot be null');
        }
     ...
     *
     * @param mixed|null $lago_invoice_id lago_invoice_id
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $lago_true_up_fee_id lago_true_up_fee_id
     *
     * @return self
     */
     ...
     *
     * @param mixed|null $lago_true_up_parent_fee_id lago_true_up_parent_fee_id
     *
     * @return self
     */
     ...
     * Sets precise_amount
     *
     * @param float|null $precise_amount The cost of this specific fee, excluding any applicable taxes, with precision.
     *
     * @return self
     */
     ...
     *
     * @param float|null $precise_total_amount The cost of this specific fee, including any applicable taxes, with precision.
     *
     * @return self
     */
     ...
     *
     * @param float|null $taxes_precise_amount The cost of the tax associated with this specific fee, with precision.
     *
     * @return self
     */
     ...
     *
     * @param float $precise_unit_amount The unit amount of the fee per unit, with precision.
     *
     * @return self
     */
    ...
    /**
     * Gets precise_coupons_amount_cents
     *
     * @return string|null
     */
    public function getPreciseCouponsAmountCents()
    {
        return $this->container['precise_coupons_amount_cents'];
    }

    /**
     * Sets precise_coupons_amount_cents
     *
     * @param string|null $precise_coupons_amount_cents The coupon amount applied to the estimated instant fee. It will always returns 0
     *
     * @return self
     */
    public function setPreciseCouponsAmountCents($precise_coupons_amount_cents)
    {
        if (is_null($precise_coupons_amount_cents)) {
            throw new \InvalidArgumentException('non-nullable precise_coupons_amount_cents cannot be null');
        }
        $this->container['precise_coupons_amount_cents'] = $precise_coupons_amount_cents;
     ...
     * Sets payment_status
     *
     * @param string $payment_status Indicates the payment status of the fee. It represents the current status of the payment associated with the fee. The value will always `pending`.
     *
     * @return self
     */
     ...
     * Sets succeeded_at
     *
     * @param mixed|null $succeeded_at succeeded_at
     *
     * @return self
     */
    ...
    public function setEventTransactionId($event_transaction_id)
    {
        if (is_null($event_transaction_id)) {
            throw new \InvalidArgumentException('non-nullable event_transaction_id cannot be null');
        }
     ...
     * Sets amount_details
     *
     * @param mixed|null $amount_details amount_details
     *
     * @return self
     */
    public function setAmountDetails($amount_details)
    {
        if (is_null($amount_details)) {
            array_push($this->openAPINullablesSetToNull, 'amount_details');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('amount_details', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets item
     *
     * @return \Lago\LagoPhpClient\Model\FeeEstimateObjectItem
     */
     ...
     * Sets item
     *
     * @param \Lago\LagoPhpClient\Model\FeeEstimateObjectItem $item item
     *
     * @return self
     */
