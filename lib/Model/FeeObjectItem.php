...
/**
 * FeeObjectItem Class Doc Comment
 *
 * @category Class
 ...
 */
class FeeObjectItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeeObject_item';
    ...
    protected static array $openAPINullables = [
        ...
        'filter_invoice_display_name' => false,
        'filters' => false,
        'lago_item_id' => false,
        'item_type' => false,
        'grouped_by' => false
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The fee type. Possible values are `add-on`, `charge`, `credit`, `subscription` or `commitment`.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string $code The code of the fee item. It can be the code of the `add-on`, the code of the `charge`, the code of the `credit` or the code of the `subscription`.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of the fee item. It can be the name of the `add-on`, the `charge`, the `credit`, the `subscription` or the `commitment`.
     *
     * @return self
     */
    ...
    public function setFilterInvoiceDisplayName($filter_invoice_display_name)
    {
        if (is_null($filter_invoice_display_name)) {
            throw new \InvalidArgumentException('non-nullable filter_invoice_display_name cannot be null');
        }
     ...
     * Sets lago_item_id
     *
     * @param string $lago_item_id Unique identifier of the fee item, created by Lago. It can be the identifier of the `add-on`, the `charge`, the `credit`, the `subscription` or the `commitment`.
     *
     * @return self
     */
     ...
     * Sets item_type
     *
     * @param string $item_type The type of the fee item. Possible values are `AddOn`, `BillableMetric`, `WalletTransaction`, `Subscription` or `Commitment`.
     *
     * @return self
     */
