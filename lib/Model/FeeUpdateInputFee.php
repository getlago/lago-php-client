...
/**
 * FeeUpdateInputFee Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class FeeUpdateInputFee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeeUpdateInput_fee';
    ...
    */
     ...
     * Sets payment_status
     *
     * @param string $payment_status The payment status of the fee. Possible values are `pending`, `succeeded`, `failed` or `refunded`.
     *
     * @return self
     */
