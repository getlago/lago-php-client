...
/**
 * AppliedCouponInputAppliedCoupon Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class AppliedCouponInputAppliedCoupon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppliedCouponInput_applied_coupon';
    ...
    */
    ...
    public function setPercentageRate($percentage_rate)
    {
        ...
        if (!is_null($percentage_rate) && (!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($percentage_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$percentage_rate when calling AppliedCouponInputAppliedCoupon., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
