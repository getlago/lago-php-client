...
/**
 * WalletTransactionPaymentFailureObject Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class WalletTransactionPaymentFailureObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WalletTransactionPaymentFailureObject';
    ...
    protected static $openAPIFormats = [
        'lago_wallet_transaction_id' => 'uuid',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['lago_wallet_transaction_id'] === null) {
            $invalidProperties[] = "'lago_wallet_transaction_id' can't be null";
        }
     ...
     *
     * @param string $lago_wallet_transaction_id Unique identifier assigned to the wallet transaction within the Lago application. This ID is exclusively created by Lago and serves as a unique identifier for the wallet transaction's record within the Lago system.
     *
     * @return self
     */
