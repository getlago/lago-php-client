...
/**
 * InvoicePreviewInputSubscriptions Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePreviewInputSubscriptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicePreviewInput_subscriptions';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['external_ids'] === null) {
            $invalidProperties[] = "'external_ids' can't be null";
        }
     ...
     * Sets plan_code
     *
     * @param string|null $plan_code The code of the plan. It serves as a unique identifier associated with the new plan to which the customer is upgrading or downgrading.
     *
     * @return self
     */
     ...
     * Sets terminated_at
     *
     * @param \DateTime|null $terminated_at The date and time when the subscription is terminated. It should defined in the future.
     *
     * @return self
     */
