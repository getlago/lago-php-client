...
/**
 * InvoiceAddOnAddedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceAddOnAddedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoiceAddOnAdded_request';
    ...
    public const WEBHOOK_TYPE_INVOICE_ADD_ON_ADDED = 'invoice.add_on_added';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_ADD_ON_ADDED,
        ];
    }
