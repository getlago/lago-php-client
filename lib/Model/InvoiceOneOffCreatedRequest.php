...
/**
 * InvoiceOneOffCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceOneOffCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'invoiceOneOffCreated_request';
    ...
    public const WEBHOOK_TYPE_INVOICE_ONE_OFF_CREATED = 'invoice.one_off_created';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INVOICE_ONE_OFF_CREATED,
        ];
    }
