...
/**
 * CustomerCreatedRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerCreatedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customerCreated_request';
    ...
    public const WEBHOOK_TYPE_CUSTOMER_CREATED = 'customer.created';
    ...
    {
        return [
            self::WEBHOOK_TYPE_CUSTOMER_CREATED,
        ];
    }
