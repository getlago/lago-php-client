...
class AppliedCouponObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'status' => false,
        'amount_cents' => true,
        'amount_cents_remaining' => true,
        'amount_currency' => true,
        'percentage_rate' => true,
        'frequency' => false,
        'frequency_duration' => true,
        'frequency_duration_remaining' => true,
        'expiration_at' => true,
        'created_at' => false,
        'terminated_at' => true
    ];
    ...
    */
    ...
    public function setAmountCentsRemaining($amount_cents_remaining)
    {
        if (is_null($amount_cents_remaining)) {
            array_push($this->openAPINullablesSetToNull, 'amount_cents_remaining');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('amount_cents_remaining', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setPercentageRate($percentage_rate)
    {
        ...
        if (!is_null($percentage_rate) && (!preg_match("/^[0-9]+.?[0-9]*$/", ObjectSerializer::toString($percentage_rate)))) {
            throw new \InvalidArgumentException("invalid value for \$percentage_rate when calling AppliedCouponObject., must conform to the pattern /^[0-9]+.?[0-9]*$/.");
        }
    ...
    public function setFrequencyDurationRemaining($frequency_duration_remaining)
    {
        if (is_null($frequency_duration_remaining)) {
            array_push($this->openAPINullablesSetToNull, 'frequency_duration_remaining');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('frequency_duration_remaining', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
