 ...
 */
class MrrObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MrrObject';
    ...
    */
     ...
     * Sets month
     *
     * @param string $month Identifies the month to analyze MRR.
     *
     * @return self
     */
     ...
     * Sets amount_cents
     *
     * @param int $amount_cents The total amount of MRR, expressed in cents.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param \Lago\LagoPhpClient\Model\Currency $currency The currency of MRR analytics. Format must be ISO 4217.
     *
     * @return self
     */
