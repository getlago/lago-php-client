...
/**
 * IntegrationProviderErrorRequest Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class IntegrationProviderErrorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'integrationProviderError_request';
    ...
    protected static $openAPITypes = [
        'webhook_type' => 'string',
        'object_type' => 'string',
        'provider_error' => '\Lago\LagoPhpClient\Model\IntegrationProviderErrorObject'
    ];
    ...
    public const WEBHOOK_TYPE_INTEGRATION_PROVIDER_ERROR = 'integration.provider_error';
    public const OBJECT_TYPE_PROVIDER_ERROR = 'provider_error';
    ...
    {
        return [
            self::WEBHOOK_TYPE_INTEGRATION_PROVIDER_ERROR,
        ];
    }
    ...
    {
        return [
            self::OBJECT_TYPE_PROVIDER_ERROR,
        ];
    }
    ...
    */
     ...
     * Gets provider_error
     *
     * @return \Lago\LagoPhpClient\Model\IntegrationProviderErrorObject
     */
     ...
     * Sets provider_error
     *
     * @param \Lago\LagoPhpClient\Model\IntegrationProviderErrorObject $provider_error provider_error
     *
     * @return self
     */
