...
/**
 * CreditNoteCreateInputCreditNote Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CreditNoteCreateInputCreditNote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditNoteCreateInput_credit_note';
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\Lago\LagoPhpClient\Model\CreditNoteCreateInputCreditNoteItemsInner[]'
    ];
    ...
    */
     ...
     * Sets invoice_id
     *
     * @param string $invoice_id The invoice unique identifier, created by Lago.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason The reason of the credit note creation. Possible values are `duplicated_charge`, `product_unsatisfactory`, `order_change`, `order_cancellation`, `fraudulent_charge` or `other`.
     *
     * @return self
     */
     ...
     *
     * @param int|null $credit_amount_cents The total amount to be credited on the customer balance.
     *
     * @return self
     */
    public function setCreditAmountCents($credit_amount_cents)
    {
        if (is_null($credit_amount_cents)) {
            array_push($this->openAPINullablesSetToNull, 'credit_amount_cents');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('credit_amount_cents', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param int|null $refund_amount_cents The total amount to be refunded to the customer.
     *
     * @return self
     */
    public function setRefundAmountCents($refund_amount_cents)
    {
        if (is_null($refund_amount_cents)) {
            array_push($this->openAPINullablesSetToNull, 'refund_amount_cents');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('refund_amount_cents', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets items
     *
     * @return \Lago\LagoPhpClient\Model\CreditNoteCreateInputCreditNoteItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \Lago\LagoPhpClient\Model\CreditNoteCreateInputCreditNoteItemsInner[] $items The list of credit note's items.
     *
     * @return self
     */
