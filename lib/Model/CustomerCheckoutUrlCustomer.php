...
/**
 * CustomerCheckoutUrlCustomer Class Doc Comment
 *
 * @category Class
 * @package  Lago\LagoPhpClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomerCheckoutUrlCustomer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerCheckoutUrl_customer';
    ...
    */
     ...
     *
     * @param string $payment_provider The Payment Provider name linked to the Customer.
     *
     * @return self
     */
     ...
     * Sets checkout_url
     *
     * @param string|null $checkout_url The new generated Payment Provider Checkout URL for the Customer.
     *
     * @return self
     */
