...
/**
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Subscriptions|\OpenAPI\Client\Model\ApiResponseUnauthorized|\OpenAPI\Client\Model\ApiResponseNotFound
     */
    public function findAllSubscriptions($external_customer_id, $page = null, $per_page = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        list($response) = $this->findAllSubscriptionsWithHttpInfo($external_customer_id, $page, $per_page, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Subscriptions|\OpenAPI\Client\Model\ApiResponseUnauthorized|\OpenAPI\Client\Model\ApiResponseNotFound, HTTP status code, HTTP response headers (array of strings)
     */
    public function findAllSubscriptionsWithHttpInfo($external_customer_id, $page = null, $per_page = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        $request = $this->findAllSubscriptionsRequest($external_customer_id, $page, $per_page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\Subscriptions' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Subscriptions' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Subscriptions', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\OpenAPI\Client\Model\Subscriptions';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\Subscriptions',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllSubscriptionsAsync($external_customer_id, $page = null, $per_page = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        return $this->findAllSubscriptionsAsyncWithHttpInfo($external_customer_id, $page, $per_page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function findAllSubscriptionsAsyncWithHttpInfo($external_customer_id, $page = null, $per_page = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Subscriptions';
        $request = $this->findAllSubscriptionsRequest($external_customer_id, $page, $per_page, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function findAllSubscriptionsRequest($external_customer_id, $page = null, $per_page = null, string $contentType = self::contentTypes['findAllSubscriptions'][0])
    {
        ...
        if ($external_customer_id === null || (is_array($external_customer_id) && count($external_customer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $external_customer_id when calling findAllSubscriptions'
            );
        }
